...
const RADIUS_Y_RATIO = 0.34;

/** Orbit semi-axis: fraction of stage width (horizontal). */
...
export const ScrollOrbitSection = () => {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const radiusX = Math.min(w * RADIUS_X_RATIO, 320);
    ...
    >
      ...
      <div className="sticky top-0 flex h-screen w-full items-center justify-center px-4 py-12">
        <div className="relative w-full max-w-6xl">
          ...
          <div
            ref={stageRef}
            className="relative mx-auto h-[min(58vmin,380px)] w-full max-w-[min(92vmin,720px)]"
          >
            <div
              ref={ellipseRef}
              aria-hidden
            ...
            {ORBIT_IMAGES.map((src, i) => (
              <div
                key={`${src}-${i}`}
                data-orbit-card
                className="absolute left-1/2 top-1/2 z-10 w-[min(26vmin,140px)] will-change-transform"
                style={{
              ...
              >
                ...
                >
                  <div className="rounded-2xl bg-gradient-to-b from-white/[0.09] to-white/[0.02] p-[10px] ring-1 ring-white/[0.11] shadow-[0_20px_40px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.06)_inset] transition-[transform,box-shadow] duration-500 ease-out group-hover:-translate-y-0.5 group-hover:shadow-[0_28px_56px_rgba(0,0,0,0.55),0_0_28px_rgba(216,200,168,0.1)]">
